...
<head>
    ...
    $(function() {
    	$("#saveStartBaoxiaoForm").submit(function() {
    		var title = $("#title");
    		var money = $("#money");
    		var remark = $("#remark");
    		var msg = "";
    		if ($.trim(title.val()) == ""){
				...
				msg = "金额不能为空！";
				money.focus();
			}else if (!/^[0-9,.]*\d+$/.test($.trim(money.val()))){
				msg = "请输入正确金额！";
				money.focus();
...
<div class="page-content">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form id="saveStartBaoxiaoForm" action="saveStartBaoxiao" method="post">
