...
<head>
    ...
    $(function() {
    	$("#saveRoleAndPermissionsForm").submit(function() {
			...
			$("#saveRoleAndPermissionsForm").submit();
		});
    	$("#permissionForm").submit(function() {
    		var name = $("#permissionForm_name");
    		var percode = $("#permissionForm_percode");
    		var msg = "";
    		if ($.trim(name.val()) == ""){
				msg = "名称不能为空！";
				name.focus();
			} else if ($.trim(percode.val()) == ""){
				msg = "权限标识不能为空！";
				percode.focus();
			}
    		if (msg != ""){
...
<div class="page-content">
    <form class="form-inline" id="saveRoleAndPermissionsForm" action="saveRoleAndPermissions" method="post">
			...
			<div class="modal-body">
				<table class="table table-bordered table-striped" width="800px">
					...
					<tr>
						<td>类型</td>
						<td>
						    <select class="form-control" id="permissionForm_type" name="type">
					...
					<tr>
					    <td>链接</td>
					    <td><input class="form-control" id="permissionForm_url" name="url" placeholder="链接">
					    </td>
					</tr>
					<tr>
						<td>权限标识</td>
						<td>
						   <input class="form-control" id="permissionForm_percode" name="percode" placeholder="权限标识">
						</td>
					</tr>
					<tr>
					    <td>父节点</td>
					    <td>
					    	<select class="form-control" id="permissionForm_parentid" name="parentid">
