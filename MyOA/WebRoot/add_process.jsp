...
<head>
	...
	<script type="text/javascript">
	   $(function() {
	   	$("#deployProcessForm").submit(function() {
...
<div class="page-content">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form id="deployProcessForm" action="${pageContext.request.contextPath}/deployProcess" enctype="multipart/form-data" method="post">
