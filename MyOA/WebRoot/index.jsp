                ...
                <div class="panel-group menu" id="accordion" role="tablist" aria-multiselectable="true">
				 <c:forEach var="menu" items="${activeUser.menuTree}" varStatus="state">
                    <div class="panel panel-inner">
                        ...
                        <div id="collapse${state.index}" <c:choose><c:when test="${state.index==0}">class="panel-collapse collapse in"</c:when>
                        	<c:otherwise>class="panel-collapse collapse"</c:otherwise></c:choose> role="tabpanel" aria-labelledby="heading${state.index}">
